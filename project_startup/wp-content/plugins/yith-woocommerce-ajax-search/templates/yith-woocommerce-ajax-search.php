...
<form role="search" method="get" id="searchform" action="<?php echo esc_url( home_url( '/'  ) ) ?>">
    <div>
        ...
        <input type="search" value="<?php echo get_search_query() ?>" name="s" id="s" placeholder="<?php echo get_option('yith_wcas_search_input_label') ?>" /><?php
        ...
        ?></select><input type="submit" id="searchsubmit" value="<?php echo get_option('yith_wcas_search_submit_label') ?>" /><input type="hidden" name="post_type" value="product" />
    </div>
</form>
</div>
